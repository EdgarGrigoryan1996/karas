const titlesText = ["Նախուտեստներ","Աղցաններ","Խավարտ","«Կարաս»-ի հատուկ փայտե վառարանում պատրաստված խորոված","Տաք ուտեստներ ","Ապուրներ","Փայտե վառարանում պատրաստված ուտեստներ","Սենդվիչներ/ Բուրգերներ","Աղանդեր","Թեյ/Սուրճ"]
const texts = {
    appetizers:[
        {
